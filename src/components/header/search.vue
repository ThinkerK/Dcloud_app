        ...
        <mt-popup v-model="popupSearch" position="right">
            <head-top>
                <div slot="head_search" class="form-ipt flex_between">
                    <input type="search" autofocus v-focus="popupSearch" v-model="Dgbh" autocomplete="off" id="popupIpt"
                        placeholder=" 请输入灯杆号" @search="onSearchKeyUp(Dgbh)">
                </div>
...
<style scoped lang="scss">
    ...
    .form-ipt {
        @include wh(9.09rem, 100%) position: relative;
    }
    ...
    .result-wrap {
        ...
        .title {
            @include wh(100%, 1rem) font-size: 0.42rem;
            font-weight: 500;
        }
