    ...
    <div class="abnormaldata full">
        ...
        <div class="section flex_col_left">
            ...
            <div class="scroll-box" style="flex: 1" id="scrollbox">
                <div id="scrollcon">
                    <div class="con-list-sm padding padding_tb" style="position:relative" v-for="(item,index) in abnormalArr"  @click = "Tolink(item,'abnormaldetails')">
                        ...
                        <div class="flex_between fontsm padding_t font-gray">异常状态: {{item.yczt}}</div>
                        <div class="flex_between fontsm padding_t font-gray">时间: {{item.ycsj}}</div>
                        <div class="xfBtn" @click.stop = "Tolink(item,'abnormalrepair')">修复</div>
                    </div>
                </div>
