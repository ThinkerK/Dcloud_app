<template>
    <div class="single-light full">
        ...
        <div class="section flex_col_left">
            <div class="font-blue padding_tb bgf" @click="addressSelect">{{checkedArea}}
                <i class="xl-blue"></i>
            </div>
            <ul class="tab-title">
            ...
            <div class="scroll-box flex1" id="scrollbox">
                <div id="scrollcon">
                    <div class="con-list-sm padding padding_tb flex_between" v-for="(item,index) in poleArr[nowIndex]" v-if="index<showIndex"
                        @click="gojzqMsg(item)">
